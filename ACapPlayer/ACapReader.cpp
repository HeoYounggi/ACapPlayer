...
void CACapReader::TotalPacket()
{
	if (m_pcReport == NULL) {
		TRACE(TEXT("m_pcReport is NULL"));
		return;
	}

	TRACE(TEXT("TotalPacket called with m_unTotalPacket = %d"), m_unTotalPacket);
	m_pcReport->OnUpdateReportTotalPacket(m_unTotalPacket);
}
//==============================================================================