...
#define WM_ACAP_SEND_FILE_NAME					(WM_USER + 1)
#define WN_ACAP_TOTAL_PACKET_COUNT				(WM_USER + 2)
//==============================================================================
...
public:
	...
	bool GetLoopDelayCount(int nLoops, int nDelay);
	...
	void OnUpdateReportTotalPacketCount(unsigned int m_unTotalPacket);

	unsigned int GetTotalPacket();
